(function () {
  ...
  const defs = {
    ...
    armorPierce: { name: "장갑 관통 제어", category: "offense", appliesTo: ["방어형 적 대응"], summary: "장갑 적에게 더 안정적인 피해를 가합니다." },
    ...
    fortress: { name: "요새 코어 프로토콜", category: "defense", appliesTo: ["보스 특수 피해"], summary: "보스가 코어에 주는 압박을 줄입니다." },

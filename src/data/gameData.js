(function () {
  ...
  const STAGES = [
    ...
    },
    {
      ...
      waves: 10,
      path: [
        [-0.04, 0.16], [0.24, 0.16], [0.24, 0.36], [0.74, 0.36],
        [0.74, 0.18], [0.92, 0.18], [0.92, 0.62], [0.34, 0.62],
        [0.34, 0.84], [1.04, 0.84],
      ],
      slots: [
        [0.16, 0.28], [0.38, 0.22], [0.58, 0.24], [0.82, 0.3],
        [0.18, 0.52], [0.48, 0.5], [0.72, 0.54], [0.24, 0.74],
        [0.52, 0.74], [0.78, 0.76],
      ],
    },
    {
      ...
      waves: 10,
      path: [
        [0.5, -0.04], [0.5, 0.14], [0.16, 0.14], [0.16, 0.42],
        [0.84, 0.42], [0.84, 0.58], [0.24, 0.58], [0.24, 0.78],
        [0.68, 0.78], [0.68, 1.04],
      ],
      slots: [
        [0.34, 0.24], [0.64, 0.24], [0.28, 0.34], [0.52, 0.34],
        [0.74, 0.34], [0.38, 0.5], [0.62, 0.5], [0.18, 0.68],
        [0.48, 0.7], [0.78, 0.7], [0.56, 0.88],
      ],
    },
    {
      name: "장갑 파쇄 협곡",
      ...
      waves: 10,
      path: [
        [0.04, 1.04], [0.04, 0.76], [0.32, 0.76], [0.32, 0.5],
        [0.12, 0.5], [0.12, 0.24], [0.58, 0.24], [0.58, 0.48],
        [0.9, 0.48], [0.9, -0.04],
      ],
      slots: [
        [0.18, 0.82], [0.42, 0.82], [0.18, 0.64], [0.48, 0.64],
        [0.24, 0.38], [0.42, 0.38], [0.7, 0.34], [0.78, 0.56],
        [0.58, 0.62], [0.82, 0.2],
      ],
    },
    {
      ...
      waves: 10,
      path: [
        [-0.04, 0.5], [0.16, 0.5], [0.16, 0.18], [0.5, 0.18],
        [0.5, 0.36], [0.84, 0.36], [0.84, 0.64], [0.42, 0.64],
        [0.42, 0.86], [1.04, 0.86],
      ],
      slots: [
        [0.1, 0.34], [0.3, 0.3], [0.44, 0.1], [0.66, 0.24],
        [0.76, 0.48], [0.58, 0.52], [0.28, 0.62], [0.18, 0.78],
        [0.52, 0.78], [0.78, 0.76], [0.9, 0.66],
      ],
    },
    {
      name: "최종 혼합 전선",
      ...
      waves: 10,
      path: [
        [0.5, -0.04], [0.5, 0.1], [0.9, 0.1], [0.9, 0.3],
        [0.12, 0.3], [0.12, 0.5], [0.82, 0.5], [0.82, 0.7],
        [0.2, 0.7], [0.2, 0.9], [1.04, 0.9],
      ],
      slots: [
        [0.34, 0.16], [0.68, 0.18], [0.78, 0.38], [0.54, 0.4],
        [0.28, 0.42], [0.26, 0.58], [0.58, 0.6], [0.72, 0.66],
        [0.36, 0.78], [0.58, 0.82], [0.86, 0.82], [0.12, 0.82],
      ],
    },
  ];
  ...
  const STAGE_RULES = [
    ...
    {
      summary: "좁은 침투로를 따라 스키터와 베놈 러너가 빠르게 코어를 노립니다.",
      rule: "고속 침투 중심",
      group: { skitter: 1.75, venomrunner: 1.65, lurker: 1.25 },
      hp: {},
      bossCooldown: 0.56,
      bossType: "riftbehemoth",
      extraGroups: [
        { wave: 4, type: "skitter", count: 7, gap: 0.22 },
        { wave: 6, type: "venomrunner", count: 5, gap: 0.32 },
      ],
    },
    {
      summary: "스웜링 물량과 베놈 러너 무리가 독성 통로를 뒤덮습니다.",
      rule: "스웜/베놈 대량 중심",
      group: { swarming: 1.8, venomrunner: 1.75, skitter: 1.35, broodcarrier: 1.2 },
      hp: {},
      bossCooldown: 0.52,
      bossType: "riftbehemoth",
      extraGroups: [
        { wave: 4, type: "swarming", count: 14, gap: 0.14 },
        { wave: 7, type: "venomrunner", count: 6, gap: 0.28 },
      ],
    },
    {
      summary: "브루트와 철갑 타이탄이 전선을 밀고 들어오는 장갑형 공세입니다.",
      rule: "장갑형 중심",
      group: { brute: 1.65, ironclad: 1.35, broodcarrier: 1.3, shellguard: 1.2 },
      hp: {},
      bossCooldown: 0.5,
      bossType: "shieldmatron",
      extraGroups: [
        { wave: 6, type: "brute", count: 3, gap: 0.78 },
        { wave: 8, type: "ironclad", count: 1, gap: 1.45 },
      ],
    },
    {
      summary: "보스가 짧은 주기로 호위 병력을 부르며 갑각 호위대와 함께 전진합니다.",
      rule: "보스 호위 중심",
      group: { brute: 1.45, lurker: 1.3, shellguard: 1.25, swarming: 1.2 },
      hp: {},
      bossCooldown: 0.46,
      bossType: "shieldmatron",
      extraGroups: [
        { wave: 5, type: "shellguard", count: 1, gap: 1.35 },
        { wave: 7, type: "brute", count: 3, gap: 0.82 },
      ],
    },
    {
      summary: "고속, 물량, 장갑, 보스 호위가 모두 섞인 최종 혼합 공세입니다.",
      rule: "최종 혼합 공세",
      group: { swarming: 1.65, skitter: 1.55, venomrunner: 1.55, brute: 1.55, ironclad: 1.25, shellguard: 1.2 },
      hp: {},
      bossCooldown: 0.42,
      bossType: "riftbehemoth",
      extraGroups: [
        { wave: 5, type: "swarming", count: 12, gap: 0.13 },
        { wave: 7, type: "venomrunner", count: 6, gap: 0.26 },
        { wave: 8, type: "brute", count: 3, gap: 0.76 },
        { wave: 9, type: "ironclad", count: 1, gap: 1.4 },
      ],
    },
  ];

  const RESEARCH_DEFS = [
    { id: "core", name: "코어 장갑 보강", desc: "스테이지 시작 코어 내구도가 레벨마다 2 증가합니다.", max: 5, baseCost: 1, tier: 1 },
    { id: "alloy", name: "초기 합금 비축", desc: "스테이지 시작 합금이 레벨마다 25 증가합니다.", max: 5, baseCost: 1, tier: 1 },
    { id: "pulse", name: "펄스 탄자 개량", desc: "펄스 캐논 피해량이 레벨마다 8% 증가합니다.", max: 5, baseCost: 1, tier: 1 },
    { id: "laser", name: "레이저 집속 렌즈", desc: "레이저 랜스 피해량이 레벨마다 8% 증가합니다.", max: 5, baseCost: 1, tier: 1 },
    { id: "targeting", name: "표적 분석", desc: "모든 타워의 피해량이 레벨마다 2% 증가합니다.", max: 5, baseCost: 1, tier: 1 },

    { id: "salvage", name: "합금 회수 프로토콜", desc: "적 처치 시 얻는 합금이 레벨마다 4% 증가합니다.", max: 5, baseCost: 2, tier: 2, requires: { parents: [{ id: "alloy", level: 2 }] } },
    { id: "capacitors", name: "축전 배치 공정", desc: "타워 배치 비용이 레벨마다 3% 감소합니다.", max: 5, baseCost: 1, tier: 1 },
    { id: "plasma", name: "플라즈마 압축탄", desc: "플라즈마 박격포 폭발 범위가 레벨마다 6% 증가합니다.", max: 5, baseCost: 1, tier: 1 },
    { id: "cryo", name: "극저온 냉각 코어", desc: "크라이오 필드의 감속 효과가 레벨마다 강해집니다.", max: 5, baseCost: 1, tier: 1 },
    { id: "arc", name: "아크 방전 증폭기", desc: "아크 테슬라 피해량이 레벨마다 8% 증가합니다.", max: 5, baseCost: 1, tier: 1 },
    ...
    { id: "allDamage", name: "전술 증폭 매트릭스", desc: "모든 타워의 피해량이 레벨마다 4% 증가합니다.", max: 5, baseCost: 2, tier: 2, requires: { parents: [{ id: "targeting", level: 2 }] } },
    { id: "recycle", name: "재판매 정산", desc: "타워 판매 회수율이 레벨마다 5% 증가합니다.", max: 5, baseCost: 3, tier: 3, requires: { parents: [{ id: "salvage", level: 2 }] } },

    { id: "repair", name: "웨이브 간 자동 수리", desc: "웨이브 종료 시 코어를 레벨마다 1 회복합니다.", max: 4, baseCost: 2, tier: 2, requires: { parents: [{ id: "core", level: 2 }] } },
    { id: "fortress", name: "요새 코어 프로토콜", desc: "5초마다 1씩 회복되어 적 1기의 공격을 막는 코어 쉴드를 레벨마다 1 제공합니다.", max: 4, baseCost: 3, tier: 3, requires: { parents: [{ id: "repair", level: 2 }] } },
    { id: "bossBreaker", name: "거대 개체 분쇄", desc: "보스에게 주는 피해가 레벨마다 8% 증가합니다.", max: 4, baseCost: 3, tier: 3, requires: { parents: [{ id: "allDamage", level: 2 }] } },
    { id: "overdrive", name: "전장 과부하", desc: "웨이브 중 모든 타워 피해량이 레벨마다 3% 증가합니다.", max: 4, baseCost: 4, tier: 4, requires: { parents: [{ id: "bossBreaker", level: 2 }] } },
    { id: "waveBonus", name: "웨이브 회수 작전", desc: "웨이브 종료 보상이 레벨마다 5% 증가합니다.", max: 4, baseCost: 2, tier: 2, requires: { parents: [{ id: "capacitors", level: 2 }] } },
  ];
